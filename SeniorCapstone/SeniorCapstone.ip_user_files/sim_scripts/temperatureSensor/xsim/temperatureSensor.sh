...
#
# Script generated by Vivado on Wed Oct 08 13:50:35 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : temperatureSensor.sh
...
#
# Usage        : temperatureSensor.sh
#                temperatureSensor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                temperatureSensor.sh [-reset_run]
#                temperatureSensor.sh [-reset_log]
#                temperatureSensor.sh [-help]
#
...
# script info
echo -e "temperatureSensor.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./temperatureSensor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot temperatureSensor xil_defaultlib.temperatureSensor xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim temperatureSensor -key {Behavioral:sim_1:Functional:temperatureSensor} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb temperatureSensor.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./temperatureSensor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: temperatureSensor.sh [-help]\n\
Usage: temperatureSensor.sh [-step]\n\
Usage: temperatureSensor.sh [-lib_map_path]\n\
Usage: temperatureSensor.sh [-reset_run]\n\
Usage: temperatureSensor.sh [-reset_log]\n\
Usage: temperatureSensor.sh [-keep_index]\n\
Usage: temperatureSensor.sh [-noclean_files]\n\n\
