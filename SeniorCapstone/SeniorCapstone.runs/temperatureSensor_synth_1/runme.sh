...
HD_PWD='C:/XilinxProjects/SeniorCapstone/SeniorCapstone.runs/temperatureSensor_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temperatureSensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temperatureSensor.tcl
